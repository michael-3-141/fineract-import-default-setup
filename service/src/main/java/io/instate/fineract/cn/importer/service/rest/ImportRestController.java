 ...
 * under the License.
 */
package io.instate.fineract.cn.importer.service.rest;

import io.instate.fineract.cn.importer.service.ImporterApplication;
import io.instate.fineract.cn.importer.service.ServiceConstants;
import io.instate.fineract.cn.importer.service.internal.command.InitializeServiceCommand;
...
public class ImportRestController {
  ...
  @Autowired
  public ImportRestController(@Qualifier(ServiceConstants.LOGGER_NAME) final Logger logger,
  ...
  ResponseEntity<String> importChartOfAccounts() {
    ...
    try {
      ...
      logger.info("Ledgers imported.");

      logger.debug("Creating account importer...");
